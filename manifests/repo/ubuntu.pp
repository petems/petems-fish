...
class fish::repo::ubuntu {
  ...
  $ubuntu_repo_name = 'ppa:fish-shell/release-2'
  ...
  exec { 'fish-add-apt-repository-ppa:fish-shell/release-2':
    command   => '/usr/bin/add-apt-repository ppa:fish-shell/release-2',
